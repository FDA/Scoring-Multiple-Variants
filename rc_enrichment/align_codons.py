...
def align_codons(fasta, output="aligned_nts.fasta", idthreshold=0.5, lenthreshold=0.2, verbose=False):
	...
	aligned_seqs = align_sequences([aa_seqs[gi] for gi in aa_seqs.keys()])	#align the aa sequences
	'''
	new_aligned_seqs = []
